...
const BooksList = ({booksList, shoppingBooks, setShoppingCart}) => {
  ...
  return (
    <div className='booksBox'>
      ...
      booksList.map((book)=> {
        ...
        return <BookItem bookItem = {book} shoppingBooksCart = {shoppingBooks} setShoppingCartBooks = {setShoppingCart} />
